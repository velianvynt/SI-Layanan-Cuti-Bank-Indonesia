...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 10 Jun 2021 pada 06.21
...
(127, '10859', 'Cuti Besar', '2021-06-03', '2021-06-05', 'pernyataan_yanti.jpg', 'Disetujui'),
...
--
-- Struktur dari tabel `tb_cuti1`
--

CREATE TABLE `tb_cuti1` (
  `id_cuti` int(11) NOT NULL,
  `nip` varchar(20) NOT NULL,
...
--
-- Dumping data untuk tabel `tb_cuti1`
--

INSERT INTO `tb_cuti1` (`id_cuti`, `nip`, `jenis_cuti`, `tanggal_mulai`, `tanggal_akhir`, `file`, `status`) VALUES
(113, '12087', 'Cuti Besar', '2021-05-28', '2021-05-29', 'IMG_20180516_200808.jpg', 'Disetujui'),
(114, '13833', 'Cuti Tahunan', '2021-07-09', '2021-07-12', 'IMG_20180516_195531.jpg', 'Ditolak'),
(115, '13835', 'Cuti Tahunan', '2021-07-06', '2021-07-09', 'received_2075367736077891.jpeg', 'Disetujui'),
(116, '14435', 'Cuti Besar', '2021-05-28', '2021-05-31', '11.jpg', 'Belum Diverifikasi');
...
INSERT INTO `tb_pegawai` (`pgw_nip`, `pgw_nama`, `pgw_tempatlahir`, `pgw_tgllahir`, `pgw_jk`, `pgw_jabatan`, `pgw_golongan`, `pgw_MasaKerja`, `pgw_PendidikanTerakhir`, `pgw_TahunLulus`, `pgw_Usia`, `pgw_file`) VALUES
('10859', 'Agus Taufik', 'Talang Empat', '1969-07-01', 'L', 'KEPALA SEKSI PUR-BN.TISM.UNIT IMPLEMENTASI PUR', 'III', 25, 'S1 Fisipol', '2001', '48 tahun', ''),
('11343', 'Kuswinarso', 'Genting Jerai', '1968-03-12', 'L', 'KEPALA UNIT.-BN.SPUR.UNIT MANAJEMEN INTERN', 'II', 25, 'S1 Ekonomi', '2001', '49 tahun', ''),
...
--
-- Indeks untuk tabel `tb_cuti1`
--
ALTER TABLE `tb_cuti1`
  ADD PRIMARY KEY (`id_cuti`),
  ADD KEY `nip` (`nip`);
...
--
ALTER TABLE `tb_cuti`
  MODIFY `id_cuti` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=132;

--
-- AUTO_INCREMENT untuk tabel `tb_cuti1`
--
ALTER TABLE `tb_cuti1`
  MODIFY `id_cuti` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=117;
...
--
-- Ketidakleluasaan untuk tabel `tb_cuti1`
--
ALTER TABLE `tb_cuti1`
  ADD CONSTRAINT `tb_cuti1_ibfk_1` FOREIGN KEY (`nip`) REFERENCES `tb_pegawai` (`pgw_nip`) ON DELETE CASCADE ON UPDATE CASCADE;
COMMIT;
